...
class MemberService(
    ...
    @Transactional
    @JvmOverloads
    open fun join(username: String, password: String?, nickname: String, profileImgUrl: String? = null): Member {
        memberRepository
        ...
        val encodedPassword = if (password != null && password.isNotBlank()) passwordEncoder.encode(password) else null
    ...
    open fun findByUsername(username: String): Optional<Member> {
    ...
    @Transactional(readOnly = true)
    open fun findById(id: Int): Optional<Member> {
    ...
    @Transactional
    open fun modifyOrJoin(username: String, password: String?, nickname: String, profileImgUrl: String?): RsData<Member> {
